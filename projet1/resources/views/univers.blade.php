...
<table class="table-auto border-collapse w-full text-center p-4">
    ...
    <tr class="border border-black m-4">
        ...
        <td><div class="border border-solid border-black p-4 rounded-lg w-20 m-auto" style="background-color: {{ $univers->couleur_principale }}"></div></td>
        <td><div class="border border-solid border-black p-4 rounded-lg w-20 m-auto" style="background-color: {{ $univers->couleur_secondaire }}"></div></td>
        @if (Auth::check())
